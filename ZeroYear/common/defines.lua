...
NGame = {
	...
	MAX_CUSTOM_COUNTRIES = 100,				-- Max is 100
	MAX_OBSERVERS = 100,						-- Max is 100
},

NDiplomacy = {
	CHANGE_RIVAL_YEARS = 50,
...
NCountry = {
	...
	CORE_LOSE_CULTURE_GROUP = 0,					-- how many years until a core in a country's culture group is lost.
	...
	OVERSEAS_DISTANCE = 10000,						-- Provinces beyond this distance to capital are distant overseas
...
NNationDesigner = {
	...
	MAX_DISTANCE_TO_OWNER_AREA = 100000,
	MAX_DISCOVERED_PROVINCE_DISTANCE = 100000,
